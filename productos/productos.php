	  ...
	  <div class="items">Manejo de motor</div>
	    <div class="content">
	      <ul>
		    ...
		    <li>M1 Development</li>
		    <li onclick="openLinkSimple('./productos/manejodemotor/m1-package-versatile.php','change');" class="vrs">M1 Package - Versatile</li>
		    <li onclick="openLinkSimple('./productos/manejodemotor/m1-package-yoyota-86.php','change');" class="toy">M1 Package - Toyota 86</li>
